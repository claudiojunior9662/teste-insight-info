...
public class IndexController {
	...
	public String showIndexPage(ModelMap model) {
		...
		model.addAttribute("atrasos", atrasoHoraExtraService.calculaAtrasos(horariosTrabalho, marcacoesFeitas));
		model.addAttribute("horasExtras", atrasoHoraExtraService.calculaHorasExtras(marcacoesFeitas, horariosTrabalho));
		return "index";
	}
